...
function rowToDiscovery(row) {
  ...
  return {
    ...
    photo: result.photo || row.image_url || null,
...
function discoveryToRow(discovery, userId, imageUrl) {
  ...
  return {
    ...
    lieu: placeName || result.placeName || null,
    latitude: latitude ?? result.latitude ?? null,
    longitude: longitude ?? result.longitude ?? null,
