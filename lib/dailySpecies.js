...
export const DAILY_SPECIES = [
  ...
  },
  {
    ...
    nom: "Le Chêne",
    latin: "Quercus robur",
    fact: "Un seul chêne peut abriter plus de 500 espèces vivantes. Un vrai hôtel !",
    emoji: "🌳",
  },
  {
    id: "pin",
...
/** Objet d'analyse pour DiscoveryAnalysisSections (fiche espèce du jour). */
export function buildDailySpeciesAnalysisData(viewModel) {
  if (!viewModel) return null;
  return {
    nom: viewModel.nom,
    nom_latin: viewModel.nom_latin,
    type: viewModel.type,
    rarete: viewModel.rarete,
    fun_fact: viewModel.fun_fact,
    description: viewModel.description,
    identification_note: viewModel.identification_note,
    famille: viewModel.famille,
    habitat: viewModel.habitat,
    guide_entretien: viewModel.guide_entretien,
    conseils_expert: viewModel.conseils_expert,
    histoire: viewModel.histoire,
  };
}
