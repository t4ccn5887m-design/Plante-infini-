...
export const HOME_SCAN_CATEGORIES = [
  ...
  { id: "legumes", labelKey: "home.category_legumes" },
];
...
const CATEGORY_API_HINTS = {
  ...
  legumes:
    "L'utilisateur cherche à identifier un légume (tomate, courgette, salade, haricot, etc.). Priorise cette catégorie dans ton analyse.",
};
